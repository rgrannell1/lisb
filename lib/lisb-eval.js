...
const lisbEval = ( function () {
	...
	*/
	...
	_levalToPrimitive = function (EXPR, SCOPE) {
		return _leval(EXPR[2], isPrimitive, SCOPE)
	}

	_levalToValname = function (EXPR, SCOPE) {
		return _leval(EXPR[1], isVALNAME, SCOPE)
	}
	...
	return function (EXPR, SCOPE) {
		return _levalToPrimitive( EXPR, SCOPE? SCOPE: Scope({}) )
	}
